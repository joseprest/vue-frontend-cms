      ...
      >
        ...
        <div class="navbar-end">
          ...
          >
            <a
              class="navbar-item"
              :class="{ 'is-active': this.$route.name.includes('products') }"
          ...
          >
            <a
              class="navbar-item"
              :class="{ 'is-active': this.$route.name.includes('benefits') }"
          ...
          >
            <a
              class="navbar-item"
              :class="{ 'is-active': this.$route.name.includes('resources') }"
          ...
          >
            <a
              class="navbar-item"
              :class="{ 'is-active': this.$route.name.includes('pricing') }"
          ...
          <router-link
            :to="$t('urls.about.url')"
            class="navbar-item"
            :class="{ 'is-active': this.$route.name.includes('about') }"
            @click.native="linkClick"
          >
            {{ $t('urls.about.label') }}
          </router-link>
            ...
            <div class="control has-icons-left">
              ...
              <div class="icon is-small is-left">
                ...
                <figure class="image is-16x16 is-hidden-desktop">
                  <img src="@/assets/imgs/worlwide.svg" alt="Select language" />
                </figure>
              </div>
            </div>
          </div>
